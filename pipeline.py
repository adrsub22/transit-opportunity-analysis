...
final_gdf['Pop_per_acre']  = np.where(final_gdf['Area_acres'] > 0, final_gdf['Tot_Pop'] / final_gdf['Area_acres'], 0)
final_gdf['Jobs_per_acre'] = np.where(final_gdf['Area_acres'] > 0, final_gdf['Jobs']    / final_gdf['Area_acres'], 0)
...
growth['Pop_Growth_Pct']  = np.where(growth['baseline_pop']  > 0, (growth['Pop_Growth']  / growth['baseline_pop'])  * 100, 0)
growth['Jobs_Growth_Pct'] = np.where(growth['baseline_jobs'] > 0, (growth['Jobs_Growth'] / growth['baseline_jobs']) * 100, 0)
...
final_gdf['Jobs_Housing_Ratio'] = np.where(final_gdf['Tot_Pop'] > 0, final_gdf['Jobs'] / final_gdf['Tot_Pop'], 0)
